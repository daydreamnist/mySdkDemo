...
public class LoginActivity extends AppCompatActivity implements View.OnClickListener {
    ...
    private void doLogin() {
        ...
        Toast.makeText(this,"phone:"+phone+",passwd:"+passwd,Toast.LENGTH_LONG).show();
        new LoginTask().execute(phone,passwd);


    }

    public class LoginTask extends AsyncTask<String, Void, BLBaseResult>{
        String phone;
        String passwd;
        ...
        protected void onPostExecute(BLBaseResult blBaseResult) {
            ...
            if (blBaseResult != null && blBaseResult.succeed()){
                ...
                Toast.makeText(LoginActivity.this,"login fail:"+blBaseResult.getMsg(),Toast.LENGTH_SHORT).show();
            }
        }
    }
}
